...
log = Logger('data_process', save2file=True, file_name= './logs/make_dpo_data.log')

def process_alpaca_gpt4_data(read_file, save_file, max_len: int=512) -> None:
    ''''
    处理RM高质量回答部分
...
if __name__ == '__main__':
    # 1. 处理chosen文本
    process_alpaca_gpt4_data('./data/dpo/alpaca_gpt4_data_zh.json', './data/dpo/alpaca_gpt4_data_zh_fix.json')
